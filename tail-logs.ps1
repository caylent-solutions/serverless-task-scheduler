# Live tail Lambda logs
# Usage: ./tail-logs.ps1 [function-name] [region]
...
Write-Host "Tailing logs for function: $FunctionName"
Write-Host "Press Ctrl+C to stop"
Write-Host "---"

# Tail logs using AWS CLI
aws logs tail "/aws/lambda/$FunctionName" --follow --format short --region $Region
